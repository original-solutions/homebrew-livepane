...
class Livepane < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/original-solutions/livepane/releases/download/v0.2.0/livepane_0.2.0_darwin_arm64.tar.gz"
      sha256 "7ee364bf4f26847ca8dc5ec338534970a7059469c9ede583317cf06602dfa673"
    end
    on_intel do
      url "https://github.com/original-solutions/livepane/releases/download/v0.2.0/livepane_0.2.0_darwin_amd64.tar.gz"
  ...
  on_linux do
    on_arm do
      url "https://github.com/original-solutions/livepane/releases/download/v0.2.0/livepane_0.2.0_linux_arm64.tar.gz"
      sha256 "e18d784bb6faf94d8b6d46a4d8ed6fadbe09d7cc9e46312f278d91b1206dd13b"
    end
    on_intel do
      url "https://github.com/original-solutions/livepane/releases/download/v0.2.0/livepane_0.2.0_linux_amd64.tar.gz"
